...
3. **Dataset Information Page**
   - Dedicated section describing the dataset source and problem context
   - Quick dataset statistics (samples, features, classes, missing values)
   - Target class distribution visualization (Dropout, Enrolled, Graduate)
   - Structured feature grouping tables for better interpretability
   - Sidebar toggle to show or hide dataset details for evaluators
